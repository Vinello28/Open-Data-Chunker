...
\input{chapters/02-architettura}
\input{chapters/03-implementazione}
\input{chapters/04-modello-dati}
\input{chapters/05-performance}
\input{chapters/06-docker}
\input{chapters/07-cli}
\input{chapters/08-inference-service}
